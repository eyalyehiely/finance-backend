        ...
        <div dir = "rtl" className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">תפריט</span>
            </h3>
            <ul className="mt-3">
              {/* Dashboard */}
          ...
          <div>
            ...
            <ul>
            <li>
              <span className="text-m font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">©CashControl©</span>
            </li>
            </ul>
          </div>
        </div>
